...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.confSegBtn.setGeometry(QtCore.QRect(940, 520, 75, 31))
        self.confSegBtn.setObjectName("confSegBtn")
        self.toolButton = QtWidgets.QToolButton(self.mFrame)
        self.toolButton.setGeometry(QtCore.QRect(660, 510, 37, 18))
